...
func SendNewUserEmail(email string) (interface{}, error) {
	...
	htmlContent += "<li><strong>List sharing:</strong> Most people who use GroceryTime use it to share grocery lists with their spouse or a friend. You can easily share any list with up to 5 people and get updates in real time - just tap the \":\" icon when viewing a list.</li>"
	htmlContent += "</ol>"
