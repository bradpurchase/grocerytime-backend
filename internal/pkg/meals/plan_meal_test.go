...
//
// Running tool: /usr/local/go/bin/go test -timeout 30s github.com/bradpurchase/grocerytime-backend/internal/pkg/meals

// 2020/12/31 11:55:30 open data/FoodClassification.json: no such file or directory
// FAIL	github.com/bradpurchase/grocerytime-backend/internal/pkg/meals	0.169s
//
